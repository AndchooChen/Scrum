...
class ScrumRTdatabase {
  ...
  // Add user to Realtime Database under specified lobbyID
  ...
  // Remove user from Realtime Database under specfied lobbyID
  ...
  // Creates a instance of a Quiz in the RealTime Database using as quiz string generated from createQuizID
